...
plt.title(f"Temperaturgleit für Massenanteil Isobutan\nfür m_ORC = {m_ORC}kg/s", fontsize=12)
plt.xlabel('Massenanteil Isobutan x_a', fontsize=14)
...
ax.set_xlabel('Massenanteil Isobutan x_a')
ax.set_ylabel('Sirr [W/K]')
ax.set_title('Gesamtentropieerzeugung (Sirr) über Massenanteil Isobutan')
...
plt.title(f"Thermischer Wirkungsgrad über Massenanteil Isobutan\nfür m_ORC = {m_ORC}kg/s", fontsize=12)
plt.xlabel('Massenanteil Isobutan x_a', fontsize=14)
...
plt.title(f"Gesamtentropieerzeugung (Sirr) über Massenanteil Isobutan\nfür m_ORC = {m_ORC}kg/s", fontsize=12)
plt.xlabel('Massenanteil Isobutan x_a', fontsize=14)
...
plt.title(f"Nettoleistung über Massenanteil Isobutan\nfür m_ORC = {m_ORC}kg/s", fontsize=12)
plt.xlabel('Massenanteil Isobutan x_a', fontsize=14)
