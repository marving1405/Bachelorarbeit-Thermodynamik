...
f = []
g = []
for Thoch_H in np.arange(100 + 273.15,200 + 273.15, 1):
    ...
    cp_oel_Tmittel_L = cp_Oel(Tmittel_L)
    ...
    R_waermeleitung2 = np.log(d_aa / d_ai) / (2 * np.pi * lambda_oel_Tmittel_L) #TODO Durchmesser hier korrekt?
