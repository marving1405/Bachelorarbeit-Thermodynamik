...
#for p2 in np.arange(100000, 2100000, 10000):
    ...
    Tlow_L = T2_siedend + 10  # pinch point temperature = 20K
    Tlow_H = Tlow_L + 20 # heiße Speicherfluidtemperatur immer 20K heißer als Abgekühlte
    p_Tank1 = 100000  # Pa
    m_WASSER = m_OEL
    ...
    Tmittel_H = T2_siedend + 70  # K #TODO pinch point definieren
    p_Tank2 = 100000  # Pa
    ...
    Te = Tmittel_H + (((Q_zu2/1000) * np.log(d_ai/d_i)) / (2 * np.pi * 25 * lambda_fluid_2))
    #dPsat = CP.PropsSI('P', 'T', Te, 'Q', 1, fluid) -
    dPsat =CP.PropsSI('P', 'T', T2_siedend, 'Q', 0, fluid) #TODO dPsat
    ...
    dTA_2 = Tmittel_H - T2_siedend
    dTB_2 = Tmittel_L - T2_sattdampf
    ...
    Thoch_L = 150 + 273.15  # K
    dTA_3 = Thoch_H - T2_sattdampf
    l3 = 15  # m festgelegt
    ...
    T3 = fsolve(solveT3, 400., args=(Q_zu3, R_ges3, Thoch_L, dTA_3))
    print(T3)
    ...
    Te_kuehlmittel1 = T4 - 20 #pinch point temperature = 20K difference
    ...
    m_Kuehlmittel2 = 50E-3


    Q_ab2 = m_ORC * (h4_siedend - h1)
    Te_kuehlmittel2 = T4_siedend - 10 #pinch point temperature = 10K difference
...
plt.title("Nettoleistung über Verdampfungsdruck für versch. TH", fontsize=14)
plt.xlabel('Thoch_H [Pa]', fontsize=14)
