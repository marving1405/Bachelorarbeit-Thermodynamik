...
Te_1 = 200 + 273.15
T3 = 367.456 #Berechnet mit LMTD-Methode
h3 = PropsSI('H','T',T3,'P',p2,fluid)

"""
Berechnung der Speicherfluideigenschaften für den Mitteltemperaturtank
"""
m_oel = 40E-3 #kg/s #TODO implemtieren Verhältnis aus ORC Massenstrom und Oelmassenstrom
cp_oel = 1.9 #kJ/kg*K
...
'''
Parameter für alpha-Berechnung für Wärmeübertrager 1 mit Tank
'''
...
Q_zu1 = m_ORC * cp_fluid_1 * delta_T2_1
...
Q_ab = m_ORC * cp_fluid_41 * delta_T41
