...
Dieses Skript variiert die Verdampfungstemperatur des Prozesses zur Teillastuntersuchung
"""
...
for p2 in np.arange(p2_start, p2_ende, schrittweite):
    ...
    p1 = 100000  # Pa
    T1 = 229  # Kelvin
    etaP = 0.9  # wird hier als konstant betrachtet
...
ax.set_title('Entropieströme über Verdampfungstemperatur', fontsize=17)
...
plt.xlabel('Verdmpfungstemperatur T2_b [K]', fontsize=15)
plt.ylabel('Nettoleistung [W]', fontsize=15)
