...
#for m_ORC in np.arange(5E-3,40E-3,1E-3):
...
Tlow_L = fsolve(solveT, 270., args=(Q_zu1, R_ges1, T2, dTB_1))
...
R_waermeleitung3 = np.log(d_aa / d_ai) / (2 * np.pi * l3 * lambda_Kupfer)
